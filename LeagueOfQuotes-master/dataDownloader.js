...
function setupQuotesData() {
        ...
        background: {
            parser: function ($, championName, isTabbed) {
                ...
                if (isTabbed) {
                    ...
                    } else if (championName === "Kayn") {
                        // i think this is the fix for Kayn as he has three forms
                        list = list.add($($("#Quotes").parent().nextAll(".tabber").first().children(".tabbertab")[1]).children());
                        list = list.add($($("#Quotes").parent().nextAll(".tabber").first().children(".tabbertab")[2]).children());
                    }
                } else {
    ...
    var parserInfo = {
        ...
        "Camille": {parser: wikiParsers.quotes, isTabbed: false},
        ...
        "Ivern": {parser: wikiParsers.quotes, isTabbed: false},
        ...
        "Kayn": {parser: wikiParsers.quotes, isTabbed: true},
        "Kennen": {parser: wikiParsers.background, isTabbed: false},
        "Kled": {parser: wikiParsers.quotes, isTabbed: false},
        ...
        "Ornn": {parser: wikiParsers.quotes, isTabbed: false},
        ...
        "Rakan": {parser: wikiParsers.quotes, isTabbed: false},
        ...
        "Xayah": {parser: wikiParsers.quotes, isTabbed: false},
        ...
        "Zoe": {parser: wikiParsers.quotes, isTabbed: false},
